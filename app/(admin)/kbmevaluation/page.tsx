...
import { getEvaluationRecapList } from "@/lib/services/evaluationService";
...
async function RecapList({ profile }: { profile: Profile }) {
  const recaps = await getEvaluationRecapList({
  ...
  return (
    <>
      <div className="flex flex-wrap justify-between items-center gap-4 mb-6">
        <Breadcrumb pageName="Rekap Penilaian Generus" showNav={false} />
        <Link
          href="/kbmevaluation/new"
